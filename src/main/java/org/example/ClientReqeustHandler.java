...
public class ClientReqeustHandler implements Runnable{

    private static final Logger logger = LoggerFactory.getLogger(ClientReqeustHandler.class);

    private final Socket clientSocket;

    public ClientReqeustHandler(Socket clientSocket) {
